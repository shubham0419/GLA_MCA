...
const insertOptions = ()=>{
  for (let i = 0; i < countyCOde.length; i++) {
    const option = `<option value="${countyCOde[i]}">${countyCOde[i]}</option>`;
    countryFrom.insertAdjacentHTML("beforeend", option);
    countryTo.insertAdjacentHTML("beforeend", option);
  }
}
insertOptions();